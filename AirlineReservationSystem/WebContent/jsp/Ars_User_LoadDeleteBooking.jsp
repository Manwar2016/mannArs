...
<c:if test="${passengersList ne null}">
...
<tr>
 ...
 <c:forEach var="passengers" items="${passengersList}">
		...
		<tr>
			...
			<td><c:out value="${passengers.emailId}" /></td>
			<td><c:out value="${passengers.mobileNo}" /></td>
			<td><c:out value="${passengers.gender}" /></td>
			<td><a href="http://localhost:8080/AirlineReservationSystem/processDeleteBooking.htm?id=${passengers.passengerId}"><input type="submit" value="Delete"/></a></td>
		</tr>
